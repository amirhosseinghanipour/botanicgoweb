...
<svelte:head>
  <title>Privacy Policy - Botanic</title>
  <meta name="description" content="Privacy Policy for Botanic AI Chat Platform" />
</svelte:head>
  ...
  <div class="prose dark:prose-invert max-w-none">
    ...
    <section class="mb-8">
      ...
      <ul class="list-disc pl-6 mb-4">
        ...
        <li>Authentication data (for OAuth providers)</li>
        <li>Chat session history and content</li>
